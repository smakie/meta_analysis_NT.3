...
ml_meta_model.3l_mod_main_language.outlier.b1 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ main_language, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 1)


ml_meta_model.3l_mod_main_language.outlier.b1
...
#Leave 1 out
ml_meta_model.3l_mod_NT_type.1.outlier.b1 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 1)

ml_meta_model.3l_mod_NT_type.1.outlier.b2 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 2)

ml_meta_model.3l_mod_NT_type.1.outlier.b3 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 3)

ml_meta_model.3l_mod_NT_type.1.outlier.b4 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 4)

ml_meta_model.3l_mod_NT_type.1.outlier.b5 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 5)

ml_meta_model.3l_mod_NT_type.1.outlier.b6 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 6)

ml_meta_model.3l_mod_NT_type.1.outlier.b7 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 7)

ml_meta_model.3l_mod_NT_type.1.outlier.b8 <- rma.mv.outlier(meta_tib, struct = "CS", method = "REML", mods = ~ NT_type.1, random = ~1 | study_id/effect, cluster = meta_tib$effect, b = 8)



ml_meta_model.3l_mod_NT_type.1.outlier.b1
ml_meta_model.3l_mod_NT_type.1.outlier.b2
ml_meta_model.3l_mod_NT_type.1.outlier.b3
ml_meta_model.3l_mod_NT_type.1.outlier.b4
ml_meta_model.3l_mod_NT_type.1.outlier.b5
ml_meta_model.3l_mod_NT_type.1.outlier.b6
ml_meta_model.3l_mod_NT_type.1.outlier.b7
...
vardist.3l(model = ml_meta_model.3l, digits =  10)$variances %>% sum() 
