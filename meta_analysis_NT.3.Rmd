...
ramani_et_al.2015_tib <- c(
  ...
  "ramani_et_al.2015l") %>% data.frame() %>% rename(., effect = .) %>% add_column(
    ...
    MA_measure = c("Counting", "Counting", "Number_Identification", "Number_Identification", "Counting", "Counting", "Cardinality", "Cardinality", "Number_Sense", "Number_Sense", "Magnitude_Comparison", "Magnitude_Comparison"),
...
elliott_et_al.2017_tib <- c(
  ...
  data.frame() %>% rename(., effect = .) %>% 
    add_column(
      ...
      child_age_study_start = c(2116.928, 2116.928, 2116.928, 2116.928),
      ...
      time_between_NT_mid_MA= c(0, 0, 0, 0),
      ...
      NT_size.1 = c("Overall", "Small", "Medium", "Large"),
      NT_type = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.1 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.2 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.3 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.4 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.5 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.6 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.7 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.8 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.9 = c("Overall", "Overall", "Overall", "Overall"),
      NT_type.10 = c("Overall", "Overall", "Overall", "Overall"),
      MA_test = c("TEMA_3", "TEMA_3", "TEMA_3", "TEMA_3"),
      MA_measure = c("Overall", "Overall", "Overall", "Overall"),
      analysis = c("Zero_Order_Correlation", "Zero_Order_Correlation", "Zero _Order_Correlation", "Zero_Order_Correlation"),
...
boonen_et_al.2011_tib <- c(
  ...
  data.frame() %>% rename(., effect = .) %>% 
    add_column(
      ...
      child_age_study_start = c(1899.3, 1899.3, 1899.3, 1899.3, 1899.3, 1899.3),
      ...
      time_between_NT_mid_MA = c(NA, NA, NA, NA, NA, NA),
      intervention_dosage = c(NA, NA, NA, NA, NA, NA),
      NT_context = c("School", "School", "School", "School", "School", "School"),
      MA_context = c("School", "School", "School", "School", "School", "School"),
      NT_size = c("Overall", "Overall","Overall","Overall", "Overall", "Overall"),
      NT_size.1 = c("Overall", "Overall","Overall","Overall", "Overall", "Overall"),
      NT_type = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.1 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.2 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.3 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.4 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.5 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.6 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.7 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.8 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.9 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      NT_type.10 = c("Calculation", "Conventional_Nominatives", "Counting", "Ordering", "Number_Symbols", "Cardinality"),
      MA_test = c("AD_Number_Sense", "AD_Number_Sense", "ENT_R", "ENT_R", "ENT_R", "Quantity_Comparison_Task"),
      MA_measure = c("Number_Sense", "Number_Sense", "Number_Sense", "Number_Sense", "Number_Sense", "Number_Sense"),
      analysis = c("Multiple_Regression", "Multiple_Regression", "Multiple_Multilevel_Regression", "Multiple_Multilevel_Regression", "Multiple_Multilevel_Regression", "Multiple_Regression"),
...
casey_et_al.2018_tib <- c(
  ...
  data.frame() %>% rename(., effect = .) %>% 
    add_column(
      ...
      MA_measure = c("Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving", "Mathematical_Problem_Solving"),
...
zippert_et_al.2019_tib <- c(
  ...
  data.frame() %>% rename(., effect = .) %>% 
    add_column(
      ...
      MA_measure = c("Counting", "Counting", "Counting", "Counting", "Number_Sense", "Number_Sense", "Number_Sense", "Number_Sense"),
...
silver_et_al.2021_tib <- c(
  ...
  data.frame() %>% rename(., effect = .) %>% 
    add_column(
      ...
      design.2 = c("Cross_sectional_Correlational", "Cross_sectional_Correlational", "Cross_sectional_Correlational"), 
      ...
      child_age_study_start = c(1430.562, 1430.562, 1430.562),
      ...
      time_between_NT_mid_MA = c(0, 0, 0),
      intervention_dosage = c(NA, NA, NA),
      NT_context = c("Lab", "Lab" , "Lab"),
      MA_context = c("Lab", "Lab", "Lab"),
      NT_size = c("Overall", "Overall", "Overall"),
      NT_size.1 = c("Overall", "Overall", "Overall"),
      NT_type = c("Overall", "Overall", "Overall"),
      NT_type.1 = c("Overall", "Overall", "Overall"),
      NT_type.2 = c("Overall", "Overall", "Overall"),
      NT_type.3 = c("Overall", "Overall", "Overall"),
      NT_type.4 = c("Overall", "Overall", "Overall"),
      NT_type.5 = c("Overall", "Overall", "Overall"),
      NT_type.6 = c("Overall", "Overall", "Overall"),
      NT_type.7 = c("Overall", "Overall", "Overall"),
      NT_type.8 = c("Overall", "Overall", "Overall"),
      NT_type.9 = c("Overall", "Overall", "Overall"),
      NT_type.10 = c("Overall", "Overall", "Overall"),
      MA_test = c("TEMA_3", "TEMA_3", "TEMA_3"),
      MA_measure = c("Overall", "Overall", "Overall"),
      analysis = c("Zero_Order_Correlation", "Simple_Slopes", "Simple_Slopes"),
...
meta_tib <- escalc(measure = "ZCOR", ri = r, ni = n, data = meta_tib.p1) %>% data.frame() %>% 
    ...
    n = as.numeric(n)) %>% 
  dplyr::mutate(
    MA_measure = forcats::fct_relevel(MA_measure, "Calculation", "Cardinality", "Counting", "Magnitude_Comparison", "Mathematical_Problem_Solving", "Number_Identification", "Number_Knowledge", "Number_Sense", "Overall"),
    ...
    NT_size.1 = forcats::fct_relevel(NT_size.1, "Small", "Medium", "Large", "Overall"))
...
```{r ml_meta_analysis}
#Meta-regression
rma(yi = yi, vi = vi, mod = ~ NT_measure_time,data = meta_tib, method  = "DL")
#Bubble plot 
...
rma(yi = yi, vi = vi, data = meta_tib, method  = "REML", test = "t")
...
english_vs_mean <- c(-1/2, 1/2)
contrasts(meta_tib$main_language) <- english_vs_mean

#Moderator analysis
ml_meta_model_mod_main_language <- rma.mv(yi = yi, V = vi, data = meta_tib, struct = "CS", method = "REML", test = "t",
       mods = ~ factor(main_language),
       random = ~ 1 | sample_id/effect)
ml_meta_model_mod_main_language
#Moderator analysis indicates that the language significantly moderated the effect
#English has a stronger positive effect than Dutch
...
#---Conventional_Nominatives (0.3242)
#---Labelling (0.5616)
#NT that have significantly smaller effect 
#---Calculation NT (-0.3069)
#---Counting NT (-0.1831)
#---Ordering NT (-0.2991)
...
#NT that have significantly greater effect 
#---Cardinality (0.2025)
#---Conventional_Nominatives (0.3382)
#---Labelling (0.5344)
#NT that have significantly smaller effect 
#---Calculation NT (-0.2928)
#---Counting NT (-0.1805)
#---Ordering NT (-0.2851)
...
#NT that have significantly greater effect 
#---Cardinality (0.2025)
#---Conventional Nominatives (0.3382)
#---Labelling(0.5344)
#NT that have significantly smaller effect 
#---Calculation NT (-0.2928)
#---Counting NT (-0.1805)
...
#SIGNIFICANT RESULTS
#NT that have significantly greater effect 
#---Conventional_Nominatives (0.3902)
#---Labelling (0.4267)
#NT that have significantly smaller effect 
#---Counting NT (Negative effect: estimate = -0.1953)
#---Number Identification NT (Negative Effect: estimate = -0.2644)
##DIFFERENT LUMPING DID NOT AFFECT THE RESULT
```
...
#INTERCEPT = 0.1149
#NT that have significantly greater effect 
#---Conventional_Nominatives (Estimate = 0.3687)
#---Labelling (Estimate = 0.4821)
#NT that have significantly smaller effect 
#---Counting NT (-0.2330)
```
...
#INTERCEPT = 	0.0691
#NT that have significantly greater effect 
#---Conventional_Nominatives (Estimate = 0.3647)
#---Labelling (Estimate = 0.4460)
#NT that have significantly smaller effect 
#---Counting NT (Negative effect: Estimate = -0.2510)
```
...
#NT that have significantly greater effect 
#--- Cardinality (0.2148)
#---Conventional_Nominatives (Estimate = 0.3469)
#---Labelling (Estimate = 0.4860)
#NT that have significantly smaller effect 
#---Counting NT (Negative effect: Estimate = -0.1846)
#--- Calculation NT (-0.2841)
#--- Ordering (-0.2764)
```
...
#NT that have significantly greater effect 
#--- Cardinality (0.2026)
#---Conventional_Nominatives (Estimate = 0.3348)
#---Labelling (Estimate = 0.4960)
#NT that have significantly smaller effect 
#---Counting NT (Negative effect: Estimate = -0.2010)
#--- Calculation NT (	-0.2963)
#--- Ordering (	-0.2885)
```
...
#NT that have significantly greater effect 
#--- Cardinality (0.2102)
#---Conventional_Nominatives (Estimate = 0.3522)
#---Labelling (Estimate = 0.5215)
#NT that have significantly smaller effect 
#--- Calculation NT (-0.2789)
#--- Ordering (-0.2711)
```
...
#INTERCEPT = 0.0501
#NT that have significantly greater effect 
#---Conventional_Nominatives (Estimate =	0.3242)
#---Labelling (Estimate = 0.5215)
#NT that have significantly smaller effect 
#---Counting NT (Negative effect: Estimate = -0.1831)
#--- Calculation NT (-0.3069)
#--- Ordering (-0.2991)
```


```{r moderator_analysis_NT_size.1}
#Checking the levels for NT_type.2
levels(meta_tib$NT_type.10)

#Setting contrast weights 
small_vs_mean <- c(0.5, 0, 0, -0.5)
medium_vs_mean <- c(0, 0.5, 0, -0.5)
large_vs_mean <- c(0, 0, 0.5, -0.5)

contrasts(meta_tib$NT_size.1) <- cbind(
  small_vs_mean, 
  medium_vs_mean,            
  large_vs_mean)

ml_meta_model_mod_NT_size.1 <- rma.mv(yi = yi, V = vi, data = meta_tib, struct = "CS", method = "REML", test = "t",
                                      mods = ~ NT_size.1, 
                                      random = ~ 1 | sample_id)
ml_meta_model_mod_NT_size.1
...
#RESULTS 
#Measuring MA in Lab has a greater effect 
...
#Multilevel Simple Regression
ml_meta_model_mod_child_age_NT_mid <- rma.mv(yi = yi, V = vi, data = meta_tib, struct = "CS", method = "REML", test = "t",
                                             mods = ~ child_age_NT_mid, 
                                             random = ~ 1 | sample_id/effect)
ml_meta_model_mod_child_age_NT_mid
#The time between NT measure and MA measure significantly diminished the effect NT on MA

#Regression Plot
regplot(ml_meta_model_mod_child_age_NT_mid, xlab = "Time Between Number Talk and Maths Ability Measure (Days)")
```
...
#Multilevel Simple Regression indicated that the number of controlled variables in the effect significantly moderated the effects
#The more number of controlled variables the smaller the effect 
...
#Multilevel Simple Regression shows that the proportion of mothers significantly enhanced the effect NT on MA
