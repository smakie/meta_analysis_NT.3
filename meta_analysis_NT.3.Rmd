...
ma.mv.influence(random = ~1 | study_id/effect, struct = "CS", data = meta_tib, method = "REML", cluster = "study_id", CHE = TRUE, r = dr)v_CHE <- impute_covariance_matrix(filter(meta_tib, )$vi, cluster = meta_tib$study_id, r = dr)
...
#CLUBSANDWICH 
coef_test(ml_meta_model.3lCHE_mod_MA_measure, vcov="CR2", cluster=meta_tib$study_id, test = "naive-tp")
