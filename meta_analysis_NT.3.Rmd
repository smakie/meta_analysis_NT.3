...
#Level 1 weights 
list.inverse.variances <- 1/(meta_tib$vi)

#Sum of those level 1 weights
sum.inverse.variances <- sum(list.inverse.variances)

#Square the sum of weights 
squared.sum.inverse.variances <- (sum.inverse.variances)^2


list.inverse.variances.square <- 1/(meta_tib$vi^2)
...
I2_1 <- (estimated.sampling.variance)/(ml_meta_model.3l$sigma2[1] + ml_meta_model.3l$sigma2[2] + estimated.sampling.variance)

I2_2 <- (ml_meta_model.3l$sigma2[2]) / (ml_meta_model.3l$sigma2[1] + ml_meta_model.3l$sigma2[2] + estimated.sampling.variance)

I2_3 <- (ml_meta_model.3l$sigma2[1]) / (ml_meta_model.3l$sigma2[1] + ml_meta_model.3l$sigma2[2] + estimated.sampling.variance)
