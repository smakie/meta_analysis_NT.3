...
#Forest plot
forest(ml_meta_model, addpred = T, header = T)

#Funnel plot
funnel(ml_meta_model)
...
ml_meta_model$k
#RESULTS
# Fisher's z = 0.0844, se = 0.0376, p = 0.0296
# tau^2 = 0.0092 
...
ml_meta_model_mod_MA_measure <- rma.mv(yi = yi, V = vi, data = meta_tib, struct = "CS", method = "REML", test = "t",
                                      mods = ~ MA_measure, 
                                      random = ~ 1 | study_id)
ml_meta_model_mod_MA_measure
#SIGNIFICANT RESULTS
#INTERCEPT = 	0.0497
